...
### 🔭 Current Focus
* 📂 **Featured Framework:** [Strategic Modeling Methodology](https://github.com/drawnparadigm-modelconsulting/consulting-methodology) - A breakdown of my analytical approach.
* 🟢 **Currently:** Refining the [Predictive Revenue Case Study](https://github.com/drawnparadigm-modelconsulting/consulting-methodology/blob/main/case-study-01.md).
* 🛠️ **Next Up:** Developing SQL-based data auditing templates.
